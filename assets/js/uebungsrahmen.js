...
(() => {
  ...
  /* Diese Liste ist die zweite Hälfte der Freigabe; die erste steht als
     frame-src in der Content-Security-Policy jeder Seite. Aufgenommen wird
     nur, was das Einbetten auch erlaubt: apps.zum.de und LEIFIchemie etwa
     verbieten es (frame-ancestors bzw. X-Frame-Options) und lieferten hier
     ein leeres Fenster — deshalb stehen von dort keine Übungen im Projekt. */
  const ERLAUBTE_HOSTS = [
    'learningapps.org', 'serlo.org', 'allgemeinbildung.ch', 'schlaukopf.de',
  ...
  window.Chemie710Uebungsrahmen = { oeffnen };
})();
